...
export class CapabilityManager {
  ...
  require(key: string, capability: Capability, ctx: Record<string, unknown> = {}): void { if (!this.check(key, capability, ctx)) throw new CapabilityError(`Capability denied: "${key}" requires "${capability}"`, key, capability); }
