...
export class ToolRegistry {
  ...
  setBeforeInvoke(mw) { this._beforeInvoke = mw; }
  setAfterInvoke(mw) { this._afterInvoke = mw; }
  ...
  clearHistory() { this._invocationHistory = []; }
  clear() { this._tools.clear(); this._invocationHistory = []; }
  destroy() { this.clear(); this._beforeInvoke = null; this._afterInvoke = null; }
}
